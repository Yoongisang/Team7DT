...
ATeam7DTSportsCar::ATeam7DTSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UTeam7DTSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UTeam7DTSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UTeam7DTSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UTeam7DTSportsWheelRear::StaticClass();
